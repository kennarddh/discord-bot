		...
		const embed = new EmbedBuilder()
			...
			.setDescription(
				[
					...
					'',
					'**Individual Values**',
					`**Health Individual Values**: ${iv.health}/31`,
					`**Attack Individual Values**: ${iv.attack}/31`,
					`**Defense Individual Values**: ${iv.defense}/31`,
					`**Special Attack Individual Values**: ${iv.specialAttack}/31`,
					`**Special Defense Individual Values**: ${iv.specialDefense}/31`,
					`**Speed Individual Values**: ${iv.speed}/31`,
					'',
					'**Effort Values**',
